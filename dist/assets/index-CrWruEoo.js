      ...
      <tbody>
        ${e.map(e=>`<tr class="pmb-tr" data-id="${e.id}" style="cursor:pointer;${U.has(e.id)?`background:hsl(215 80% 97%);`:``}">
          ...
          <td><span style="display:inline-flex;align-items:center;gap:4px;padding:4px 10px;border-radius:20px;font-size:0.7rem;font-weight:700;letter-spacing:.03em;white-space:nowrap;
            ${e.metode===`online`?`background:hsl(215 80% 93%);color:hsl(215 70% 38%);border:1px solid hsl(215 60% 82%);`:`background:hsl(270 60% 93%);color:hsl(270 55% 42%);border:1px solid hsl(270 45% 82%);`}
          ">${e.metode===`online`?`🌐 Online`:`🏢 Offline`}</span></td>
          <td><span style="display:inline-flex;align-items:center;gap:4px;padding:4px 10px;border-radius:20px;font-size:0.7rem;font-weight:700;letter-spacing:.03em;white-space:nowrap;
            ${e.status===`diterima`?`background:hsl(142 65% 90%);color:hsl(142 60% 28%);border:1px solid hsl(142 50% 78%);`:e.status===`ditolak`?`background:hsl(0 70% 92%);color:hsl(0 65% 38%);border:1px solid hsl(0 55% 80%);`:e.status===`proses`?`background:hsl(225 70% 92%);color:hsl(225 65% 40%);border:1px solid hsl(225 55% 80%);`:`background:hsl(38 80% 91%);color:hsl(38 70% 36%);border:1px solid hsl(38 60% 78%);`}
          ">${e.status===`diterima`?`✅ Diterima`:e.status===`ditolak`?`❌ Ditolak`:e.status===`proses`?`🔄 Proses`:`⏳ Menunggu`}</span></td>
