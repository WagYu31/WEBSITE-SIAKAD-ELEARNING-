...
Data yang dihapus tidak dapat dikembalikan.`))return;let a=l.findIndex(e=>e.id===r);a>=0&&(l.splice(a,1),alert(`✅ Dosen berhasil dihapus`),e.innerHTML=$t()+t,en(e,t))})})}var tn={mahasiswa:Te,dosen:Fe,kaprodi:Ye,bap:Xe};function nn(e){let t=Vn();if(!t){window.location.hash=`#/login`;return}let n=tn[t.role]||Te;if(e.innerHTML=`
