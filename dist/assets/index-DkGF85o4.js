...
Detail: `+(o.error_detail||o.error||`Unknown`));break}window.open(t,`_blank`)||alert(`⚠️ Popup diblokir browser.

Silakan klik link berikut:
`+t);let n=document.createElement(`div`);n.style.cssText=`position:fixed;bottom:24px;right:24px;background:hsl(215 25% 15%);color:white;padding:16px 24px;border-radius:12px;z-index:9999;box-shadow:0 8px 30px rgba(0,0,0,0.3);max-width:380px;font-size:0.85rem;line-height:1.5;`,n.innerHTML=`
