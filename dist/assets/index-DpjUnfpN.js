...
Detail: `+(o.error_detail||o.error||`Unknown`));break}if(!window.snap){let e=o.client_key||`Mid-client-mGA7v04cXrux3KNF`;await new Promise((t,n)=>{let r=document.createElement(`script`);r.src=`https://app.sandbox.midtrans.com/snap/snap.js`,r.setAttribute(`data-client-key`,e),r.onload=t,r.onerror=n,document.head.appendChild(r)})}window.snap.pay(e,{onSuccess:function(e){alert(`✅ Pembayaran berhasil!
