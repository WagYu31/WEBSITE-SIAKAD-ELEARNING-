    ...
    <div class="dash-card" style="overflow:hidden;border:2px solid hsl(210 55% 50%);">
      ...
      <div class="dash-card-body" style="padding:20px;">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(160px,1fr));gap:14px;margin-bottom:14px;">
          ...
          <div id="jfRuangWrap"><label style="${i}">Ruang Kelas${o===`gabungan`?` <span style="font-size:0.62rem;color:hsl(40 70% 45%);">Adm. Niaga</span>`:``}</label><input id="jfRuang" type="text" value="${e?.ruang||``}" placeholder="${o===`gabungan`?`RN-101`:`RA-201`}" style="${r}"></div>
          <div id="jfRuang2Wrap" style="display:${o===`gabungan`?`block`:`none`};"><label style="${i}">Ruang Kelas <span style="font-size:0.62rem;color:hsl(145 55% 40%);">Adm. Negara</span></label><input id="jfRuang2" type="text" value="${e?.ruang2||``}" placeholder="RA-201" style="${r}"></div>
